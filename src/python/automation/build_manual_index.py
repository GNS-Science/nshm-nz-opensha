...
if __name__ == "__main__":
    ...
    GID = "R2VuZXJhbFRhc2s6OTU0TEg1WXk="
    #GID = "R2VuZXJhbFRhc2s6OTI5cDNicTY="

    UPLOAD_FOLDER = "DATA15"
    ...
    info_keys = ['mfd_equality_weight', 'mfd_inequality_weight','slip_rate_normalized_weight' ] # 'round', 'max_inversion_time'
