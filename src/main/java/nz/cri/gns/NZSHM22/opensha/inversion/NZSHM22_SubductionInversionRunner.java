...
public class NZSHM22_SubductionInversionRunner extends NZSHM22_AbstractInversionRunner {
	 ...
	 * @return
	 */
	public NZSHM22_SubductionInversionRunner setGutenbergRichterMFD(double totalRateM5, double bValue, double mfdTransitionMag) {
	...
	public NZSHM22_SubductionInversionRunner configure() {
		...
		inversionConfiguration = NZSHM22_SubductionInversionConfiguration.forModel(inversionModel, rupSet,
				mfdEqualityConstraintWt, mfdInequalityConstraintWt, totalRateM5, bValue, mfdTransitionMag);
	...
	public static void main(String[] args) throws IOException, DocumentException {
		...
		NZSHM22_SubductionInversionRunner runner =  ((NZSHM22_SubductionInversionRunner) new NZSHM22_SubductionInversionRunner()
			...
			.setGutenbergRichterMFD(2.4, 1.3, 7.75)
			.configure();
